    ...
    <div  class="header">
        ...
        <div class="headerButtons">
            ...
            <a class="nav-link" href="#" onclick="mostrarForms()">
                <img src="../img/Agregar.png" alt = "Agregar Feed">    
            </a>
    ...
    <div class="noticias">
        ...
        <div class="botones">
            ...
            <button id="btn_actualizar" onclick="update()">
                <img src = "../img/actualizar.png" alt = "Actualizar Feed">
            </button>
        </div>
        <div class="feed"></div>
    </div>
